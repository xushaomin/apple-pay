...
import com.appleframework.pay.common.core.config.MqConfig;
...
public class RpNotifyServiceImpl implements RpNotifyService {
	...
	public void orderSend(String bankOrderNo) {
		...
		String orderNotifyQueueName = PropertyConfigurer.getString(MqConfig.ORDER_NOTIFY_QUEUE);
		jmsTemplate.setDefaultDestinationName(orderNotifyQueueName);
