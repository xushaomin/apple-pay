package com.appleframework.pay.reconciliation.utils.alipay;
...
public class AlipaySubmit {
	 ...
	 * 合作身份者ID，签约账号
	 */
	private static final String PARTNER = PropertyConfigurer.getString("alipay.partner");

	/**
	 * MD5密钥，安全检验码
	 */
	private static final String KEY = PropertyConfigurer.getString("alipay.key");

	/**
	 * 支付宝提供给商户的服务接入网关URL(新)
	 */
	private static final String ALIPAY_GATEWAY_NEW = PropertyConfigurer.getString("alipay.alipay_gateway_new");

	/**
	 * 签名方式
	 */
	private static final String SIGN_TYPE = PropertyConfigurer.getString("alipay.sign_type");

	/**
	 * 字符编码格式 目前支持
	 */
	private static final String INPUT_CHARSET = PropertyConfigurer.getString("alipay.input_charset");
