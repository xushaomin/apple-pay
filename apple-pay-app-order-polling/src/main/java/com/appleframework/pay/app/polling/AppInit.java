 ...
 */
package com.appleframework.pay.app.polling;
...
import com.appleframework.pay.app.polling.core.PollingPersist;
import com.appleframework.pay.app.polling.core.PollingTask;
...
public class AppInit {
	...
	public void init() {
		try {
			context = SpringUtility.getApplicationContext();
