 ...
 */
package com.appleframework.pay.common.core.entity;
...
public class BaseEntity implements Serializable {
	...
	private static final long serialVersionUID = 8570709876430696165L;
	
	private String id = IdUtil.nextId().toString();// 主键ID.
