...
/**
 * 账户信息 http://www.appleframework.com
 * 
 * @author Cruise.Xu
 */
@Controller
...
public class AccountController extends BaseController {
	...
	public String ajaxAccountInfo(HttpServletRequest request, @RequestBody JSONParam[] params)
		...
		String json = "{\"sEcho\":" + sEcho + ",\"iTotalRecords\":" + count.longValue() + ",\"iTotalDisplayRecords\":"
	...
	@ResponseBody
	public ApiCommonResultVo savePayPass(HttpServletRequest request)
			throws IllegalAccessException, InvocationTargetException {
		RpUserInfo rpUserInfo = (RpUserInfo) request.getSession().getAttribute(ConstantClass.USER);
